<div class="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-3">
 ...
 <button  @onClick ("open = !open")  aria-expanded="false" aria-haspopup="menu" id=":rd2:"
            ...
            <div  x-show="open" @click.away="open = false" class="bg-white min-w-[180px] p-3 border border-blue-gray-50 rounded-md shadow-lg shadow-blue-gray-500/10 font-sans text-sm font-normal text-blue-gray-500 overflow-auto focus:outline-none z-[999]"
                                        ...
                                        @if ($activity->client_id === $client->id)
                                            <div class="w-10/12">
                                                ...
                                                <div
                                                    ...
                                                    @if ($activity->semaforo === 'rosso')
                                                        <div class="flex justify-center items-center h-full overflow-hidden break-all rounded-full bg-red-600 text-white"
                                                            style="width: 60%;"></div>
                                                    @elseif ($activity->semaforo === 'giallo')
                                                        <div class="flex justify-center items-center h-full overflow-hidden break-all rounded-full bg-yellow-500 text-white"
                                                            style="width: 60%;"></div>
                                                    @elseif ($activity->semaforo === 'verde')
                                                        <div class="flex justify-center items-center h-full overflow-hidden break-all rounded-full bg-green-600 text-white"
                                                            style="width: 60%;"></div>
                                                    @endif
                                                </div>
                                            </div>
            ...
            <div class="flex items-start gap-4 py-3">
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"class="h-3.5 w-3.5"
                        viewBox="0 0 576 512"fill="currentColor" stroke="currentColor" stroke-width="1">
                        <path fill-rule="evenodd"
                ...
                <div>
                    <p class="antialiased font-sans text-sm leading-normal text-blue-gray-900 block font-medium">
                        Filtra per nome Azienda</p><span
                        class="block antialiased font-sans text-xs font-medium text-blue-gray-500">
